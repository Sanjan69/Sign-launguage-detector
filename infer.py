...
# Function to apply cartoon filter to an image
def apply_cartoon_filter(image):
    ...
    # Combine the edges and color image to create the cartoon effect
...
while True:
    ...
    frame_rgb = cv2.cvtColor(cartoon_frame, cv2.COLOR_BGR2RGB)
